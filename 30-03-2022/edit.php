...
<body>
    <form method="POST">
        ...
        <input type="submit" name="updt" value="Update"></br>
...
$query=mysqli_query($a,"update student set where email=$email") or die("Error in updating Data");
if($query) {
    echo "Data Inserted";
}
else {
