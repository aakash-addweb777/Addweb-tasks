...
$a=$_GET['fvalue'];
$b=$_GET['svalue'];
echo "<a href=querystring2.php?fvalue=$a&svalue=$b&btn1=Subtract>Edit</a>";
}
if(isset($_GET['Multiply']))
{
$a=$_GET['fvalue'];
$b=$_GET['svalue'];
echo "<a href=querystring2.php?fvalue=$a&svalue=$b&btn1=Multiply>Edit</a>";
}
if(isset($_GET['Divide']))
{
$a=$_GET['fvalue'];
$b=$_GET['svalue'];
echo "<a href=querystring2.php?fvalue=$a&svalue=$b&btn1=Add>Divide>Edit</a>";
}
?>