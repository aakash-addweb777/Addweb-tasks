...
if($_POST['addition']) {
    echo "hi";
    header('Location:addsunglasses.php');
}
if(($_POST['ed'])) {
        header('Location:editsunglasses.php');
}
if(($_POST['del'])) {
    header('Location:deletesunglasses.php');
}
ob_start();
...
while($row=mysqli_fetch_array($query))
{
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=deletesunglasses.php?id=$id>Delete data</a>"."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=editsunglasses.php?id=$id>Edit data</a>"."</td>";
    echo "</tr>";
    ...
    echo "</div>";
    echo "<center>";
    echo "<br><a href=addsunglasses.php>Add data</a>";
    echo "</center>";
?>
</div>
        </div>
