              ...
              <form method="post">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <button type="submit" class="btn btn-lg btn-primary btn-block mb-4" name="si">Sign In</button>
                    <p>Don't have an account yet ?
                      <a class="text-blue" href="signup.php" name="su" >Sign Up</a>
                    </p>
                  </div>
                </div>
              </form>
...
$query=mysqli_query($a,"select * from ntable where id='$id' and password='$password'") or die("Error in query");
