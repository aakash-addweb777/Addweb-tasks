...
if($_POST['addition']) {
    echo "hi";
    header('Location:addbags.php');
}
if(($_POST['ed'])) {
        header('Location:editbags.php');
}
if(($_POST['del'])) {
    header('Location:deletebags.php');
}
ob_start();
...
while($row=mysqli_fetch_array($query))
{
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=deletebags.php?id=$id>Delete data</a>"."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=editbags.php?id=$id>Edit data</a>"."</td>";
    echo "</tr>";
    ...
    echo "</div>"; 
    echo "<center>";
    echo "<br><a href=addbags.php>Add data</a>";
    echo "</center>";
?>
</div>
        </div>
