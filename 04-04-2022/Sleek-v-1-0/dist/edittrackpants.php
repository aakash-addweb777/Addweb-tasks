...
$query = mysqli_query($a,"select * from trackpants where Trid=$id") or die("error in query");
...
$a = mysqli_connect("localhost","root","","base24") or die("error in connection");
$abc="update trackpants set size='$size', Color='$color', Brand='$Brand',Details='$Details',Material='$material',Fabric='$fabric',img_url='$img' where Trid=$id";
echo $abc;
