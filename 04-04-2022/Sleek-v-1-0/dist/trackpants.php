...
if($_POST['addition']) {
    echo "hi";
    header('Location:addtrackpants.php');
}
if(($_POST['ed'])) {
        header('Location:edittrackpants.php');
}
if(($_POST['del'])) {
    header('Location:deletetrackpants.php');
}
ob_start();
...
while($row=mysqli_fetch_array($query))
{
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=deletetrackpants.php?id=$id>Delete data</a>"."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=edittrackpants.php?id=$id>Edit data</a>"."</td>";
    echo "</tr>";
    ...
    echo "</div>";
    echo "<center>";
    echo "<br><a href=addtrackpants.php>Add data</a>";
    echo "</center>";
?>
</div>
        </div>
