...
if($_POST['addition']) {
    echo "hi";
    header('Location:addcaps.php');
}
if(($_POST['ed'])) {
        header('Location:editcaps.php');
}
if(($_POST['del'])) {
    header('Location:deletecaps.php');
}
ob_start();
...
while($row=mysqli_fetch_array($query))
{
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=deletecaps.php?id=$id>Delete data</a>"."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=editcaps.php?id=$id>Edit data</a>"."</td>";
    echo "</tr>";
    ...
    echo "</div>"; 
    echo "<center>";
    echo "<br><a href=addcaps.php>Add data</a>";
    echo "</center>";
?>
</div>
        </div>
