...
if($_POST['addition']) {
    echo "hi";
    header('Location:addheadphones.php');
}
if(($_POST['ed'])) {
        header('Location:editheadphones.php');
}
if(($_POST['del'])) {
    header('Location:deleteheadphones.php');
}
ob_start();
...
while($row=mysqli_fetch_array($query))
{
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=deleteheadphones.php?id=$id>Delete data</a>"."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=editheadphones.php?id=$id>Edit data</a>"."</td>";
    echo "</tr>";
    ...
    echo "</div>"; 
    echo "<center>";
    echo "<br><a href=addheadphones.php>Add data</a>";
    echo "</center>";
?>
</div>
        </div>
