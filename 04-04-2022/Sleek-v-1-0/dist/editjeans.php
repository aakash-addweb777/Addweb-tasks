...
$a = mysqli_connect("localhost","root","","base24") or die("error in connection");
$abc="update jeans set size='$size', Color='$color', Brand='$Brand',Details='$Details',Material='$material',Fabric='$fabric',img_url='$img' where Tid=$id";
echo $abc;
