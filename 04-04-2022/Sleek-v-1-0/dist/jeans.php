...
if($_POST['addition']) {
    echo "hi";
    header('Location:addjeans.php');
}
if(($_POST['ed'])) {
        header('Location:editjeans.php');
}
if(($_POST['del'])) {
    header('Location:deletejeans.php');
}
ob_start();
...
while($row=mysqli_fetch_array($query))
{
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=deletejeans.php?id=$id>Delete data</a>"."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=editjeans.php?id=$id>Edit data</a>"."</td>";
    echo "</tr>";
    ...
    echo "</div>"; 
    echo "<center>";
    echo "<br><a href=addjeans.php>Add data</a>";
    echo "</center>";
?>
</div>
        </div>
