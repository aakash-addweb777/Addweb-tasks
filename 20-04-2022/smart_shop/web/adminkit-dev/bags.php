...
ob_start();
echo "<table  ><thead><tr><th><i>Bags</i></th></tr></thead>";
...
while($row=mysqli_fetch_array($query))
{
    ...
    echo "<td>"."<a href=viewbags.php?id=$id>View</a>"."</td>";
    echo "<td>"."<a href=deletebags.php?id=$id>Delete</a>"."</td>";
    echo "<td>"."<a href=editbags.php?id=$id>Edit</a>"."</td>";
    echo "</tr></tbody>";
    ...
    echo "</table>"; 
    echo "<br><a href=addbags.php>Add</a><br>";
