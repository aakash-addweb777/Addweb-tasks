...
<!-- contact -->
	<div class="contact">
		<div class="container">
			...
			<h3 class="tittle">Select payment option</h3>
			<form method="post">
				<div class="contact-form2">
                    <label>Cash on delivery</label>
					<input type="radio"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}" required="">
                    <label>Emi</label>
					<input type="radio"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required="">
...
$mail->isSMTP(); // the mailer is set to use SMTPpay.php
...
$mail->AddAddress("aakashchamoli19@gmail.com");
$mail->AddReplyTo("aakashchamoli19@gmail.com", "Hello");
