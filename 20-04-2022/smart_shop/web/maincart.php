		...
		<div class="container">
						...
						<table class="timetable_sub">
							...
							<tr class="rem1">
								<td class="invert-closeb">
									<div>
										<div> <?php echo "<a href=delete.php?id=$id>Remove </a>" ?></div>
									</div>
								...
								<td class="invert-image">
									...
									<?php echo "<a href=maincart.php?id=$id><img src=$img  height=80px width=70px ></a>"  ?></td>
								<td class="invert">
									<div class="quantity">
								...
								<td class="invert"><?php echo "<a href=maincart.php?id=$id><h4>$brand  $name </h4></a>" ?></td>
								<td class="invert"><?php echo "<a href=maincart.php?id=$id><h4>Rs $price </h4></a>" ?></td>
							</tr>
			...
			<div class="checkout-left">
				...
				<div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
					<a href="address.php"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Place Order</a>
				</div>
