...
while($row=mysqli_fetch_array($query))
{
    ...
    echo "<td>"."<a href=viewtshirts.php?id=$id>View</a>"."</td>";
    echo "<td>"."<a href=deletetshirts.php?id=$id>Delete</a>"."</td>";
    echo "<td>"."<a href=edittshirts.php?id=$id>Edit</a>"."</td>";
    echo "</tr></tbody>";
    ...
    echo "</table>"; 
    echo "<br><a href=addtshirts.php>Add</a><br>";
