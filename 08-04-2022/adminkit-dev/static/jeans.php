...
ob_start();
echo "<table  ><thead><tr><th><i>Jeans</i></th></tr></thead>";
...
while($row=mysqli_fetch_array($query))
{
    ...
    echo "<td>"."<a href=viewjeans.php?id=$id>View</a>"."</td>";
    echo "<td>"."<a href=deletejeans.php?id=$id>Delete</a>"."</td>";
    echo "<td>"."<a href=editjeans.php?id=$id>Edit</a>"."</td>";
    echo "</tr></tbody>";
    ...
    echo "</table>"; 
    echo "<br><a href=addjeans.php>Add</a><br>";
