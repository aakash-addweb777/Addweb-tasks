...
ob_start();
echo "<table  ><thead><tr><th><i>Shirts</i></th></tr></thead>";
...
while($row=mysqli_fetch_array($query))
{
    ...
    echo "<td>"."<a href=viewshirts.php?id=$id>View</a>"."</td>";
    echo "<td>"."<a href=deleteshirts.php?id=$id>Delete</a>"."</td>";
    echo "<td>"."<a href=editshirts.php?id=$id>Edit</a>"."</td>";
    echo "</tr></tbody>";
    ...
    echo "</table>"; 
    echo "<br><a href=addshirts.php>Add</a><br>";
