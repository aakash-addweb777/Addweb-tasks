...
ob_start();
echo "<table  ><thead><tr><th><i>Caps</i></th></tr></thead>";
...
while($row=mysqli_fetch_array($query))
{
    ...
    echo "<td>"."<a href=viewcaps.php?id=$id>View</a>"."</td>";
    echo "<td>"."<a href=deletecaps.php?id=$id>Delete</a>"."</td>";
    echo "<td>"."<a href=editcaps.php?id=$id>Edit</a>"."</td>";
    echo "</tr></tbody>";
    ...
    echo "</table>"; 
    echo "<br><a href=addcaps.php>Add</a><br>";
